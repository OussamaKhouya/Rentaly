...
export default function LocaleSwitcherSelect({
  ...
  return (
    <div className="relative dark:bg-white dark:rounded-full">
      <Select.Root defaultValue={defaultValue} onValueChange={onChange}>
        ...
        >
          <Select.Icon>
            <LanguageIcon className="h-6 w-6 text-blue-500 dark:text-black transition-colors group-hover:text-gray-200" />
          </Select.Icon>
        </Select.Trigger>
        <Select.Portal>
          <Select.Content
